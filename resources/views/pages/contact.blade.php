...
<<<<<<< HEAD
            <p class="text-3xl my-2 text-gray-700">Ready to transform and bring impact to your business?</p>

            <div
                class="w-fit mx-auto flex flex-col md:flex-row md:items-center md:space-x-6 space-y-4 md:space-y-0 text-lg my-6">
=======
...
<<<<<<< HEAD
            <h3 class="mb-6 text-blue-900 text-4xl font-extrabold">Tell Us About Your Project</h3>
            <form action="" class="flex flex-col space-y-6">
                <div class="flex flex-col space-y-1">
                    <label for="name" class="text-lg font-semibold text-gray-800">Full Name</label>
                    <input type="text" placeholder="Enter your full name"
                        class="w-full p-4 border border-gray-300 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-orange-300 transition duration-200" />
                </div>
                ...
                <div class="flex flex-col space-y-1">
                    <label for="company" class="text-lg font-semibold text-gray-800">Company</label>
                    <input type="text" placeholder="Company name"
                        class="w-full p-4 border border-gray-300 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-orange-300 transition duration-200" />
                </div>

                <div class="flex flex-col space-y-1">
                    <label for="description" class="text-lg font-semibold text-gray-800">Project Description</label>
                    <textarea rows="6" placeholder="Describe your project (Optional)"
                        class="w-full p-4 border border-gray-300 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-orange-300 transition duration-200"></textarea>
                </div>

                <button
                    class="mt-6 bg-orange-600 hover:bg-orange-700 text-white py-3 px-8 rounded-lg font-semibold transition duration-300 ease-in-out shadow-lg w-fit">
=======
...
<<<<<<< HEAD
            <h3 class="mb-6 text-blue-900 text-4xl font-extrabold text-center">Frequently Asked Questions</h3>

            <div class="space-y-6 text-gray-800">
                <div class="p-4 bg-white rounded-lg shadow-md transition-shadow hover:shadow-xl">
                    <h4 class="text-xl font-semibold text-orange-700">What does Sesware Nexus do?</h4>
                    <p class="text-gray-600">We build custom software tailored to your business needs — from web platforms
=======
...
>>>>>>> 6265ef8e500c56b74c1ef07232cac8945d37cabc
                ...
                <div class="p-4 bg-white rounded-lg shadow-md transition-shadow hover:shadow-xl">
<<<<<<< HEAD
                    <h4 class="text-xl font-semibold text-orange-700">What services do you offer?</h4>
                    <p class="text-gray-600">We specialize in full-stack development, APIs, UI/UX, system integration, and
=======
...
>>>>>>> 6265ef8e500c56b74c1ef07232cac8945d37cabc
                ...
                <div class="p-4 bg-white rounded-lg shadow-md transition-shadow hover:shadow-xl">
<<<<<<< HEAD
                    <h4 class="text-xl font-semibold text-orange-700">What are your pricing models?</h4>
                    <p class="text-gray-600">Pricing depends on project scope — we offer fixed, hourly, and retainer-based
=======
...
>>>>>>> 6265ef8e500c56b74c1ef07232cac8945d37cabc
                ...
                <div class="p-4 bg-white rounded-lg shadow-md transition-shadow hover:shadow-xl">
<<<<<<< HEAD
                    <h4 class="text-xl font-semibold text-orange-700">Do you provide ongoing support?</h4>
                    <p class="text-gray-600">Absolutely! We offer post-launch support, maintenance, and scaling services as
=======
